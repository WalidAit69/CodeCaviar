      ...
      <div className="w-full max-w-[100rem] max-[1700px]:max-w-[90%] max-[500px]:max-w-[95%] mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          >
            ...
            />
            <span
              className="flex items-center gap-2 font-bold font-Monument text-xl relative dark:drop-shadow-[0_0_0.3rem_#ffffff70] 
            bg-black dark:bg-white duration-300 group-hover:bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent"
            >
              Code Caviar
            </span>
          </a>
